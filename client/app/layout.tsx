...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Post Office Agent Pratapgarh", "India Post Agent Manoj Mishra", "Manoj Mishra Pratapgarh",
    "Best Post Office Agent in Pratapgarh", "Manoj Mishra Head Post Office", "Manoj Mishra Pratapgarh",
    "Pratapgarh Post Office Investment Agent", "Manoj Mishra RD FD Agent", "Manoj Mishra Pratapgarh",
    "Authorized Post Office Agent Pratapgarh", "Manoj Kumar Mishra Post Office", "Manoj Mishra Pratapgarh",
    "Investment Advisor Pratapgarh", "Manoj Mishra Savings Schemes", "Manoj Mishra Pratapgarh",
    "Head Post Office Pratapgarh Agents", "manoj mishra postoffice", "Manoj Mishra Contact Number", "Manoj Mishra Pratapgarh",
    ...
    "Monthly Income Scheme Agent", "MIS Post Office Agent", "NSC KVP Agent", "Manoj Mishra Pratapgarh",
